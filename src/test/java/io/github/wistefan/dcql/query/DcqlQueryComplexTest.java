...
class DcqlQueryComplexTest extends DcqlTest {
    ...
    private static final Credential MDOC_MDL_ID = new Credential(CredentialFormat.MSO_MDOC, new MDocCredential( null, null, Map.of(
    ...
    private static final Credential MDOC_MDL_ADDRESS = new Credential(CredentialFormat.MSO_MDOC, new MDocCredential( null, null, Map.of(
            "credential_format", "mso_mdoc",
            "docType", "org.iso.18013.5.1.mDL",
    ...
    private static final Credential MDOC_PHOTO_CARD_ID = new Credential(CredentialFormat.MSO_MDOC, new MDocCredential( null, null, Map.of(
            "credential_format", "mso_mdoc",
    ...
    private static final Credential MDOC_PHOTO_CARD_ADDRESS = new Credential(CredentialFormat.MSO_MDOC, new MDocCredential( null, null, Map.of(
            "credential_format", "mso_mdoc",
            "docType", "org.iso.23220.photoid.1",
    ...
    private static final Credential MDOC_EXAMPLE = new Credential(CredentialFormat.MSO_MDOC, new MDocCredential( null, null, Map.of(
            "credential_format", "mso_mdoc",
    ...
    private static final Credential SD_JWT_VC_EXAMPLE = new Credential(CredentialFormat.VC_SD_JWT, new SdJwtCredential( null,
            new JwtCredential( null, null, Map.of(
