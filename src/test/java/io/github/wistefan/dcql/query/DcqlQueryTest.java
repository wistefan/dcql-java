...
class DcqlQueryTest extends DcqlTest {
    ...
    private static final Credential EXAMPLE_MDOC = new Credential(CredentialFormat.MSO_MDOC, new MDocCredential( null, null, Map.of(
            ...
            new SdJwtCredential( null,
                    new JwtCredential( null, null,
                            Map.of(
                                    ...
                                    "_sd", List.of(getDisclosure("hash-b", "first_name", "Arthur").getSdHash(), getDisclosure("hash-c", "last_name", "Dent").getSdHash()),
                                    "address", Map.of("_sd", List.of(getDisclosure("hash-a", "street_address", "42 Market Street").getSdHash(), "hash-x")),
                                    "cryptographic_holder_binding", false), null),
                    List.of(getDisclosure("hash-a", "street_address", "42 Market Street"),
                            getDisclosure("hash-b", "first_name", "Arthur"),
                            getDisclosure("hash-c", "last_name", "Dent"))
            ));

    private static final Credential EXAMPLE_W3C_LDP_VC = new Credential(CredentialFormat.LDP_VC, new LdpCredential( null, Map.of(
