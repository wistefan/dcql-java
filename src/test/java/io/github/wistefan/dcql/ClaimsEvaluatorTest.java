...
class ClaimsEvaluatorTest {
	...
	public void testEvaluateForJwtCredential(ClaimsQuery claimsQuery, Map<String, Object> credential, boolean expectedResult) {
		JwtCredential jwtCredential = new JwtCredential(null, credential, null);
	...
	public void testEvaluateForJwtCredential(ClaimsQuery claimsQuery, Map<String, Object> payload, List<Disclosure> disclosures, Optional<List<Disclosure>> expectedDisclosures) {
		...
		SdJwtCredential sdJwtCredential = new SdJwtCredential(new JwtCredential(null, payload, null), disclosures);
	...
	public static Stream<Arguments> sdJwtArgs() {
		return Stream.of(
				Arguments.of(
						...
						Map.of("test", Map.of("_sd", List.of("hash-a", "hash-b"))),
						List.of(new Disclosure("hash-a", "a", "b"), new Disclosure("hash-b", "c", "d")),
						Optional.of(List.of(new Disclosure("hash-a", "a", "b")))),
				Arguments.of(
				...
				Arguments.of(
						...
						Map.of("_sd", List.of("hash-a", "hash-b"), "test",Map.of("_sd", List.of("hash-c"))),
						List.of(new Disclosure("hash-a", "a", "b"), new Disclosure("hash-b", "c", "d"), new Disclosure("hash-c", "e", "f")),
						Optional.of(List.of(new Disclosure("hash-c", "e", "f"))))
		);
	}
